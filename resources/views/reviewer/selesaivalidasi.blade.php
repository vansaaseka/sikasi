                            ...
                            <tbody>
                                ...
                                @foreach ($pengajuan as $datapengajuan)
                                    @if ($datapengajuan->kategori_id == 1)
                                        @if (App\Models\Trxstatus::where('pengajuan_id', $datapengajuan->id)->orderBy('id', 'desc')->where('status_id', '>=', 3)->first())
                                            <tr role="row" class="odd text-center">
                                                ...
                                                @php
                                                    $trz = App\Models\Trxstatus::where('pengajuan_id', $datapengajuan->id)
                                                        ->orderBy('id', 'desc')
                                                        ->first();
                                                @endphp
                                                <td>
