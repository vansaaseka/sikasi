                                          ...
                                          @foreach ($pp as $pp)
                                              <tr role="row" class="">
                                                  ...
                                                  <td style="text-align:center">
                                                      {{ date('Y', strtotime($pp->tanggalmulai)) }}</td>
                                                  <td>
                                                      <?php
                                                    foreach($kategori as $ka){
                                                        if($ka->id == $pp->kategori_id){?>
                                                      {{ $ka->namakategori }} <?php }
                                                    }
                                                ?>
                                                  </td>
                                                  ...
                                                  <td>{{ $pp->mitra->namamitra }}</td>

                                                  <td>
                                                      <?php $belumada_status = '<div class="btn btn-outline-warning btn-sm"></i>Belum ada Status</div>'; ?>
                                                      @foreach ($trxstatus as $a)
                                                          @if ($pp->id == $a->pengajuan_id)
                                                              @foreach ($status as $b)
                                                                  @if ($a->status_id == $b->id)
                                                                      <?php $belumada_status = '<div class="btn btn-outline-primary btn-sm dropdown-toggle ' . $pp->id . '" data-bs-toggle="modal" data-bs-target="#status' . $pp->id . '"id="#status' . $pp->id . '"> ' . $b->namastatus . ' </div>'; ?>
                                                                  @endif
                                                              @endforeach
                                                          @endif
                                                      @endforeach
                                                      ...
                                                      {{-- Modal Tampil Status --}}
                                                      <div class="modal fade" id="status{{ $pp->id }}" tabindex="-1"
                                                  ...
                                                  <td> @php
                                                      $tsz = App\Models\Trxstatus::where('pengajuan_id', $pp->id)
                                                          ->orderBy('id', 'desc')
                                                          ->first();
                                                  @endphp
                                                      @isset($tsz)
                                                ...
                                                foreach($dokumen as $d){
                                                    if($d->pengajuan_id == $pp->id){?>
                                                      <a
                                                          href="dokumenkerjasama/{{ $d->dokumen }}">{{ $d->dokumen }}</a>
                                                      <?php }
                                                }
                                                ?>
                                                      <?php
                                            ...
                                            if($item->pengajuan_id == $pp->id){?>
                                                  ...
                                                  <td> <button type="button" class="btn btn-info btn-sm"
                                                          ...
                                                          data-bs-target="#modaldetail{{ $pp->id }}"
                                                          id="#modaldetail{{ $pp->id }}">
                                                          <i class="fa fa-info-circle"></i>
                                                      </button>
                                                      <!-- Modal Detail -->
                                                      <div class="modal fade" id="modaldetail{{ $pp->id }}"
                                                                          ...
                                                                          <table
                                                                              ...
                                                                              <tbody>
                                                                                  ...
                                                                                  <tr>
                                                                                      ...
                                                                                      <td>:</td>
                                                                                      <td>{{ $pp->created_at->formatLocalized('%A, %d %B %Y') }}
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td>
                                                                                      ...
                                                                                      <td>:</td>
                                                                                      <td>{{ date('l, d-m-Y', strtotime($pp->tanggalmulai)) }}
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td>
                                                                                      ...
                                                                                      <td>:</td>
                                                                                      <td>{{ date('l, d-m-Y', strtotime($pp->tanggalakhir)) }}
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td>
                                                                                      ...
                                                                                      <td style="color: red">
                                                                                          ...
                                                                                          @php
                                                                                              $tr = App\Models\Trxstatus::where('pengajuan_id', $pp->id)
                                                                                                  ->orderBy('id', 'desc')
                                                                                                  ->first();
                                                                                          @endphp
                                                                                          @isset($tr)
                                                                                              @foreach (App\Models\Status::where('id', $tr->status_id)->get() as $st)
                                                                                                  @if ($st->namastatus == 'Selesai')
                                                                                                      {{ $diff = Carbon\Carbon::parse($pp->tanggalakhir)->diffForHumans() }}
                                                                                                  @else
                                                                                                      Belum Disetujui
                                                                                                  @endif
                                                                                              @endforeach
                                                                                  ...
                                                                                  <tr>
                                                                                      ...
                                                                                      <td>
                                                                                          ...
                                                                                          @php
                                                                                              $tst = App\Models\Trxstatus::where('pengajuan_id', $pp->id)
                                                                                                  ->orderBy('id', 'desc')
                                                                                                  ->first();
                                                                                          @endphp
                                                                                          @isset($tst)
                                                  ...
                                                  <td>
                                                      ...
                                                      <?php $belumada_verif = '<div class="btn btn-primary btn-sm ' . $pp->id . '" data-bs-toggle="modal" data-bs-target="#modalstatus' . $pp->id . '"id="#modalstatus' . $pp->id . '"> Verifikasi </div>'; ?>
                                                      ...
                                                      {{-- Modal Edit Status --}}
                                                      <div class="modal fade" id="modalstatus{{ $pp->id }}"
                                                          tabindex="-1" role="dialog"
                                                          aria-labelledby="staticBackdropLiveLabel" aria-hidden="true"
                                                          style="text-align: left">
                                                          <div class="modal-dialog modal-dialog-scrollable"
