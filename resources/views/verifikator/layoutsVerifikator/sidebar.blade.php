    ...
    <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ 'dashboardverifikator' == request()->path() ? 'active' : '' }}"
                    href="/dashboardverifikator">
                    <i class="icon">
            ...
            <li class="nav-item">
                <a class="nav-link {{ 'verifikasi' == request()->path() ? 'active' : '' }}" href="/verifikasi">
                    <i class="icon">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4"
                    ...
                    <span class="item-name">Verifikasi Pengajuan</span>
                </a>
            </li>
