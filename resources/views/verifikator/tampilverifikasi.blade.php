                                                                            ...
                                                                            <form action="/insertnewstatus"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    {{-- <label class="form-label"
                                                                                        for="exampleInputText1">Verifikasi
                                                                                    </label> --}}
                                                                                    {{-- @foreach ($status as $s)
                                                                                    ...
                                                                                    @endforeach --}}
                                                                                    <?php $tombol = '<div class="custom-control custom-radio custom-radio-color-checked"><input type="radio" name="status_id" value="1"><label for="ajuan">Ajuan Diterima</label></div>'; ?>
                                                                                            ...
                                                                                            @for ($s = 0; $s < count($status); $s++)
                                                                                                @if ($a->status_id == $status[$s]->id)
                                                                                                    @if ($status[$s]->namastatus === 'Ajuan Diterima')
                                                                                                        ...
                                                                                                        ?>
                                                                                                        @elseif
                                                                                                        ($status[$s]->namastatus === 'Ajuan Diterima')
                                                                                                        <?php $tombol = ''; ?>
                                                                                                    @endif
                                                                                                @endif
                                                                                            @endfor
