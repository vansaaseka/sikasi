          ...
          <table class="table align-items-center table-flush">
            ...
            <tbody>
                  ...
                  <tr role="row" class="odd">
                   ...
                   <td><a href="filedrafkerjasama/{{$datadraf->filedraf}}">{{$datadraf->filedraf}}</a></td>
                    ...
                    <td>
                        ...
                        <a href="#"  class="btn btn-danger delete" id-data="{{ $datadraf->id }}" nama-data="{{ $datadraf->namadraf }}"><i class="fa fa-trash"></i></a>
                        <a href="/editdraf/{{ $datadraf->id}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
