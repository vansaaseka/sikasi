...
<div class="conatiner-fluid content-inner mt-n5 py-0">
    ...
    @foreach ($dosen as $akun)
        {{-- Modal --}}
        <div class="modal fade" id="modaleditdosen{{ $akun->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body">
                            <div class="row d-flex justify-content">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="/updateakun/{{ $akun->id }}" method="POST"
                                                enctype="multipart/form-data" class="forms-sample">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name"
                                                        ...
                                                        id="name" placeholder="Input Username" name="name"
                                                    ...
                                                    <select name="prodi_id" class="selectpicker form-control"
                                                        ...
                                                        @foreach ($prodi as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('prodi_id', $akun->prodi_id) == $item->id ? 'selected' : null }}>
                                                                {{ $item->namaprodi }}
                                                            </option>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email"
                                                        ...
                                                        autocomplete="email" value="{{ $akun->email }}">
                                                    @error('email')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="nomorTelpon">Nomor Hp</label>
                                                    <input type="number" name="nomorhp"
                                                        class="form-control @error('nomorhp') is-invalid @enderror"
                                                        id="nomorTelpon" aria-describedby="nomorhp"
                                                        placeholder="Input Nomor Hp" name="nomorhp" required
                                                        autocomplete="nomorhp" value="{{ $akun->nomorhp }}">
                                                    @error('nomorhp')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="nomorTelpon">NIP</label>
                                                    <input type="number" name="nip"
                                                        class="form-control @error('nip') is-invalid @enderror"
                                                        id="nomorTelpon" aria-describedby="nip"
                                                        placeholder="Input NIP " name="nip" required
                                                        autocomplete="nip" value="{{ $akun->nip }}">
                                                    @error('nip')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="nomorTelpon">Alamat</label>
                                                    <input type="text" name="alamat"
                                                        class="form-control @error('alamat') is-invalid @enderror"
                                                        id="nomorTelpon" aria-describedby="alamat"
                                                        placeholder="Input Alamat " name="alamat" required
                                                        autocomplete="alamat" value="{{ $akun->alamat }}">
                                                    @error('alamat')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
