            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="m-0 font-weight-bold text-primary">Daftar Akun Admin</h4>
                    </div>
                    <div id="dataTableHover_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <a href="/tambahadmin" type="button" class="btn btn-success">Tambah
                        ...
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tfoot>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($admin as $account) @if ($account->role == 1)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            @if ($account->status == 1)
                                            <a href="{{ url('/ubahstatus/'.$account->id)}}" class="bbtn btn-sm btn-success">Aktif</a>
                                            @else
                                            <a href="{{ url('/ubahstatus/'.$account->id) }}" class="bbtn btn-sm btn-danger">Non-Aktif</a>
                                            @endif
                                        </td>
                                        <td>
