            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="m-0 font-weight-bold">Daftar Akun Admin</h4>
                    </div>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#modaleditadmin{{ $account->id }}"
                                                    id="#modaleditadmin{{ $account->id }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                {{-- Modal --}}
                                                <div class="modal fade" id="modaleditadmin{{ $account->id }}"
