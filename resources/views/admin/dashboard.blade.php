    ...
    <div class="row">
                                            ...
                                            <table id="datatable" class="table table-striped"
                                                ...
                                                <tbody>
                                                    @foreach ($mitraSharing as $pengajuan)
                                                        @php
                                                            $proditerlibatIds = json_decode(
                                                                $pengajuan->proditerlibat_id,
                                                                true,
                                                            );
        ...
        <script>
            (function(jQuery) {
                ...
                if (jQuery('#pengajuan-activity').length) {
                    const options = {
                        series: [

                            {
                                name: 'Pengajuan',
                                data: [{!! json_encode($total_ajuan) !!}, {!! json_encode($total_pks) !!}, {!! json_encode($total_mou) !!},
                    ...
                    const PengajuanChart = new ApexCharts(document.querySelector("#pengajuan-activity"), options);
                    PengajuanChart.render();
                }
        ...
        <script>
            $(document).ready(function() {
                $('#datatable').DataTable(); // Memanggil plugin datatables pada tabel dengan ID "datatable"
            });
        </script>
