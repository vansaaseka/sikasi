    ...
    <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link active" aria-current="page" href="{{asset('HOPE/dashboard/index.html')}}">
                    <i class="icon">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/index-horizontal.html')}}">
                          <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/index-dual-horizontal.html')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/index-dual-compact.html')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/index-boxed.html')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/index-boxed-fancy.html')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{ 'kategori' == request()->path() ? 'active' : ''}}" href="/kategori">
                    <i class="icon">
                         <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                    ...
                    <span class="item-name">Kategori Kerjasama</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ 'template' == request()->path() ? 'active' : ''}}" href="/template">
                    <i class="icon">
                         <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                       <path opacity="0.4" d="M2 11.0786C2.05 13.4166 2.19 17.4156 2.21 17.8566C2.281 18.7996 2.642 19.7526 3.204 20.4246C3.986 21.3676 4.949 21.7886 6.292 21.7886C8.148 21.7986 10.194 21.7986 12.181 21.7986C14.176 21.7986 16.112 21.7986 17.747 21.7886C19.071 21.7886 20.064 21.3566 20.836 20.4246C21.398 19.7526 21.759 18.7896 21.81 17.8566C21.83 17.4856 21.93 13.1446 21.99 11.0786H2Z" fill="currentColor"></path>                                <path d="M11.2451 15.3843V16.6783C11.2451 17.0923 11.5811 17.4283 11.9951 17.4283C12.4091 17.4283 12.7451 17.0923 12.7451 16.6783V15.3843C12.7451 14.9703 12.4091 14.6343 11.9951 14.6343C11.5811 14.6343 11.2451 14.9703 11.2451 15.3843Z" fill="currentColor"></path>                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.211 14.5565C10.111 14.9195 9.762 15.1515 9.384 15.1015C6.833 14.7455 4.395 13.8405 2.337 12.4815C2.126 12.3435 2 12.1075 2 11.8555V8.38949C2 6.28949 3.712 4.58149 5.817 4.58149H7.784C7.972 3.12949 9.202 2.00049 10.704 2.00049H13.286C14.787 2.00049 16.018 3.12949 16.206 4.58149H18.183C20.282 4.58149 21.99 6.28949 21.99 8.38949V11.8555C21.99 12.1075 21.863 12.3425 21.654 12.4815C19.592 13.8465 17.144 14.7555 14.576 15.1105C14.541 15.1155 14.507 15.1175 14.473 15.1175C14.134 15.1175 13.831 14.8885 13.746 14.5525C13.544 13.7565 12.821 13.1995 11.99 13.1995C11.148 13.1995 10.433 13.7445 10.211 14.5565ZM13.286 3.50049H10.704C10.031 3.50049 9.469 3.96049 9.301 4.58149H14.688C14.52 3.96049 13.958 3.50049 13.286 3.50049Z" fill="currentColor">
                       </path></svg> 
                    </i>
                    <span class="item-name">Template Kerjasama</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                    <li class="nav-item">
                        <a class="nav-link {{ 'tampildosen' == request()->path() ? 'active' : ''}} " href="/tampildosen">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ 'tampiladmin' == request()->path() ? 'active' : ''}} " href="/tampiladmin">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                     ...
                     <li class="nav-item">
                        <a class="nav-link {{ 'tampilverifikator' == request()->path() ? 'active' : ''}}" href="/tampilverifikator">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ 'tampilreviewer' == request()->path() ? 'active' : ''}}" href="/tampilreviewer">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                ...
                <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/errors/error404.html')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/errors/error500.html')}}"></a>
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{asset('HOPE/dashboard/errors/maintenance.html')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
