    ...
    <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ 'dashboarddadmin' == request()->path() ? 'active' : '' }}"
                    href="/dashboardadmin">
                    <i class="icon">
            ...
            <li class="nav-item">
                <a class="nav-link {{ 'cetakpengajuan' == request()->path() ? 'active' : '' }}"
                    href="/cetakpengajuan">
                    <i class="icon">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4"
            ...
            <li class="nav-item">
                <a class="nav-link {{ 'kategorimitra' == request()->path() ? 'active' : '' }}"
                    href="/kategorimitra">
                    <i class="icon">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4"
