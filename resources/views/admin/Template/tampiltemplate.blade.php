            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div id="dataTableHover_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <a href="template/create" type="button" class="btn btn-success">Tambah
                        ...
                        <table id="basic-table" class="table table-striped mb-0" role="grid">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a href="filedrafkerjasama/{{$data->filedraf}}">{{$data->filedraf}}</a>
                                    </td>
                                  ...
                                  <div class="flex align-items-center list-user-action">
                                     <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ url('template/'.$data->id.'/edit') }}">
                                     ...
                                     <a class="btn btn-sm btn-icon btn-danger delete" id-data="{{ $data->id }}" nama-data="{{ $data->kategori->namakategori }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#">
                                        <span class="btn-inner">
